            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Add Cashier Profile</h4>
                </div>
                <div class="card-body">
                  <form>
                    <div class="row">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input required placeholder="ex.) Shashank" type="text" class="form-control">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input required type="number" placeholder="ex.) 234561266"class="form-control">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input required placeholder ="Enter Address" type="text" class="form-control">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input required placeholder ="ex.) shashank@gmail.com" type="email" class="form-control">
                        </div>
                      </div>
                    </div>
                    ...
                    <button type="submit" class="btn btn-primary pull-right">Add Cashier Profile</button>
