	...
	<div class="wrapper ">
		...
		<div class="main-panel">
						...
						<div class="col-md-8">
							<div class="card">
								<div class="card-header card-header-primary">
									<h4 class="card-title">Search For Product</h4>
								</div>
								<div class="card-body">
									<form>
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<div class="search">
														<input required type="text" class="searchTerm"
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Sales As Per Product</h4>
                </div>
                <div class="card-body">
