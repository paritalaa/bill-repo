              ...
              <div class="card">
                ...
                <div class="card-body">
                  <form>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                         ...
                         <div class="search">
    					  <input required type="text" class="searchTerm" placeholder="Search for product">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input readonly  placeholder="ex.) pears soap" type="text" class="form-control">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Quantity Available</label>
                          <input readonly  type="number" placeholder="ex.) 1"class="form-control">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Quantity Purchased</label>
